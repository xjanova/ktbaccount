...
<body x-data="{ sidebarOpen: false }" class="min-h-screen bg-gray-950">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            <a href="{{ route('admin.tenants') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('admin.tenants') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="กองทุนทั้งหมด">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3H21m-3.75 3H21" />
                </svg>
                <span>กองทุนทั้งหมด</span>
            </a>
            <a href="{{ route('admin.users') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('admin.users') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="ผู้ใช้ระบบ">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('admin.settings') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="ตั้งค่าระบบ">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
