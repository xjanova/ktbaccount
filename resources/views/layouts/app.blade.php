    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex items-center gap-3 px-6 py-5 border-b border-primary-800/50">
            ...
            <div>
                ...
                <p class="text-xs text-primary-300 truncate">{{ $isDemo ? 'กองทุนตัวอย่าง (Demo)' : (auth()->user()?->fund?->name ?? (session('impersonating_tenant_name') ?? 'กองทุนหมู่บ้าน')) }}</p>
            </div>
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            <a href="{{ route($rp . '.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('*/') || request()->is('fund') || request()->is('demo') || request()->routeIs('fund.dashboard') || request()->routeIs('demo.dashboard') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }}" title="แดชบอร์ด">
            ...
            <a href="{{ route($rp . '.transactions.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('*/transactions*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }}" title="รายรับ-รายจ่าย">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
                </svg>
                <span>รายรับ-รายจ่าย</span>
            </a>
            <a href="{{ route($rp . '.reports.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('*/reports*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }}" title="รายงาน">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route($rp . '.loans.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->is('*/loans*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }}" title="สินเชื่อ">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <span>สินเชื่อ</span>
            </a>
            <a href="{{ route($rp . '.deposits.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->is('*/deposits*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="เงินฝาก">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                </svg>
                <span>เงินฝาก</span>
            </a>
            <a href="{{ route($rp . '.shares.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->is('*/shares*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="หุ้น">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route($rp . '.members.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->is('*/members*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="รายชื่อสมาชิก">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route($rp . '.approvals.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->is('*/approvals*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="รออนุมัติ">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route($rp . '.settings') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->is('*/settings*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="ตั้งค่ากองทุน">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route($rp . '.account-sets.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->is('*/account-sets*') ? 'bg-primary-900/50 text-white' : 'text-primary-200 hover:bg-primary-900/30 hover:text-white' }} transition-colors" title="ชุดบัญชี">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400">
                            @if($isDemo)
                                กองทุนตัวอย่าง (โหมดทดลอง)
                            @elseif(session('impersonating_tenant_name'))
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.outside="open = false"
                            ...
                            <a href="{{ route($rp . '.dashboard') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors">โปรไฟล์</a>
                            <a href="{{ route($rp . '.settings') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors">ตั้งค่า</a>
                            <hr class="my-1 border-gray-700">
                            @if($isDemo)
                                <a href="/" class="block w-full text-left px-4 py-2 text-sm text-indigo-400 hover:bg-gray-700 hover:text-indigo-300 transition-colors">&larr; กลับหน้าหลัก</a>
                            @else
