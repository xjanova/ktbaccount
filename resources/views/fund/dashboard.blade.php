...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <a href="#" class="action-btn flex items-center justify-center gap-3 px-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl shadow-lg shadow-blue-600/25 hover:shadow-blue-500/40">
